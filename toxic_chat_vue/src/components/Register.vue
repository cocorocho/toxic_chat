<template>
<div class="justify-center items-center w-full shadow rounded-lg bg-white px-6 flex flex-col md:w-1/2 lg:w-1/3 m-auto">
    <h2 class="text-2xl my-4">Register</h2>
    <div id="whoobe-h90kl" class="w-full p-2 justify-start flex flex-col">
        <div id="whoobe-7izhv" class=" flex flex-row">
            ...
            <input v-model="username" class="border border-gray-200 rounded-r-lg outline-none focus:ring-1 ring-blue-400 w-full pl-1" required="true" placeholder="username">
        </div>
        ...
        <div id="whoobe-l6k6r" class="my-4 flex flex-row">
            ...
            <input v-model="password" type="password" class="h-10 border border-gray-200 rounded-r-lg outline-none focus:ring-1 ring-blue-300 w-full pl-1" placeholder="password" required="false">
        </div>
        <button value="button" class="px-4 py-2 rounded bg-blue-400 text-white hover:bg-blue-700 my-4 w-full" v-on:click="register">Register</button>
        <h5 class="text-center">Already have an account? <a class="text-blue-700" href="/login/">Login</a> here.</h5>
    </div>
</div>
</template>
